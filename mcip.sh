...
/home/randylab/imager/bin/crop $this_date/crop.jpg
...
then
	...
	do
		if [ "$i" -eq "0" ]
		then
			/home/randylab/imager/motor/close
			#sleep 2
			#/home/randylab/imager/motor/11v
			#sleep 2
			#/home/randylab/imager/motor/close
			#sleep 2
			#/home/randylab/imager/motor/11v
		...
		/home/randylab/imager/motor/"$i"v
		echo "$i"v >> $this_date/order.txt
		date | cat >> $this_date/order.txt
		ffmpeg -f video4linux2 -i /dev/video0 -t $coll_time -r 1 -s 640x480 $this_date/"$i"va_video.wmv
		ffmpeg -i $this_date/"$i"va_video.wmv -t $coll_time -r 1 -s 640x480 -vf crop=$values_array $this_date/"$i"va/image%d.jpg
		##/home/randylab/imager/bin/imager $this_date/"$i"va &
		/home/randylab/imager/motor/close
		#sleep 2
		#/home/randylab/imager/motor/11v
		#sleep 2
	...
	do
		...
		echo "$i"v >> $this_date/order.txt
		date | cat >> $this_date/order.txt
		ffmpeg -f video4linux2 -i /dev/video0 -t $coll_time -r 1 -s 640x480 $this_date/"$i"vb_video.wmv
		ffmpeg -i $this_date/"$i"vb_video.wmv -t $coll_time -r 1 -s 640x480 -vf crop=$values_array $this_date/"$i"vb/image%d.jpg
		##/home/randylab/imager/bin/imager $this_date/"$i"vb &
		/home/randylab/imager/motor/close
		#sleep 2
		#/home/randylab/imager/motor/11v
		#sleep 2
	...
	do
		...
		echo "$i"v >> $this_date/order.txt
		date | cat >> $this_date/order.txt
		ffmpeg -f video4linux2 -i /dev/video0 -t $coll_time -r 1 -s 640x480 $this_date/"$i"vc_video.wmv
		ffmpeg -i $this_date/"$i"vc_video.wmv -t $coll_time -r 1 -s 640x480 -vf crop=$values_array $this_date/"$i"vc/image%d.jpg
		##/home/randylab/imager/bin/imager $this_date/"$i"vc &
		/home/randylab/imager/motor/close
		#sleep 2
		#/home/randylab/imager/motor/11v
		#sleep 2
...
#	##/home/randylab/imager/bin/imager $this_date/"$i"v &
#done
