...
then
	...
	do
		...
		ffmpeg -i $this_date/"$i"va_video.wmv -t $coll_time -r 1 -s 640x480 -croptop ${values_array[0]} -cropbottom ${values_array[1]} -cropleft ${values_array[2]} -cropright ${values_array[3]} $this_date/"$i"va/image%d.jpg
	...
	do
		...
		ffmpeg -i $this_date/"$i"vb_video.wmv -t $coll_time -r 1 -s 640x480 -croptop ${values_array[0]} -cropbottom ${values_array[1]} -cropleft ${values_array[2]} -cropright ${values_array[3]} $this_date/"$i"vb/image%d.jpg
	...
	do
		...
		ffmpeg -i $this_date/"$i"vc_video.wmv -t $coll_time -r 1 -s 640x480 -croptop ${values_array[0]} -cropbottom ${values_array[1]} -cropleft ${values_array[2]} -cropright ${values_array[3]} $this_date/"$i"vc/image%d.jpg
